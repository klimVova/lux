...
<div class="main">
    <section class="development">
        ...
        <!-- wp:paragraph -->
        <p><strong class="privacy-policy-tutorial">Предлагаемый текст: </strong>Наш адрес сайта: http://my-course.loc.</p>
        <!-- /wp:paragraph -->
...
<?php echo do_shortcode('[contact-form-7 id="315" title="terms"]'); ?>
<?php
get_footer();
?>